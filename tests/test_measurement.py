...
class FakeDMM:
    ...
    Управления диапазоном здесь нет умышленно: в DTCal диапазон настраивается
    один раз при инициализации прибора (аппаратный автодиапазон), а
    measurement.py его не трогает.
    """
